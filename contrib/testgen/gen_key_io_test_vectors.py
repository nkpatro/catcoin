...
bech32_templates = [
  ...
  ('cat',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
...
bech32_ng_templates = [
  ...
  ('tcat',   17, 32, Encoding.BECH32M, False, False, False),
  ('rcat',  3,  1, Encoding.BECH32M, False, False, False),
  ('cat',   15, 41, Encoding.BECH32M, False, False, False),
  ('tcat',    0, 16, Encoding.BECH32,  False, False, False),
  ('rcat',  0, 32, Encoding.BECH32,  True,  False, False),
  ('cat',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tcat',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rcat',  0, 20, Encoding.BECH32,  False, False, True),
  ('cat',    0, 20, Encoding.BECH32M, False, False, False),
  ('tcat',    0, 32, Encoding.BECH32M, False, False, False),
  ('rcat',  0, 20, Encoding.BECH32M, False, False, False),
  ('cat',    1, 32, Encoding.BECH32,  False, False, False),
  ('tcat',    2, 16, Encoding.BECH32,  False, False, False),
  ('rcat', 16, 20, Encoding.BECH32,  False, False, False),
]
