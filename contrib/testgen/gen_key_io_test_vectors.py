...
bech32_templates = [
  ...
  ('joco',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('joco',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('joco',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('joco',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tjoco',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tjoco',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tjoco',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tjoco',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tjoco',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tjoco',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tjoco',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tjoco',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rjoco',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rjoco',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rjoco',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rjoco', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tjoco',   17, 32, Encoding.BECH32M, False, False, False),
  ('rjoco',  3,  1, Encoding.BECH32M, False, False, False),
  ('joco',   15, 41, Encoding.BECH32M, False, False, False),
  ('tjoco',    0, 16, Encoding.BECH32,  False, False, False),
  ('rjoco',  0, 32, Encoding.BECH32,  True,  False, False),
  ('joco',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tjoco',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rjoco',  0, 20, Encoding.BECH32,  False, False, True),
  ('joco',    0, 20, Encoding.BECH32M, False, False, False),
  ('tjoco',    0, 32, Encoding.BECH32M, False, False, False),
  ('rjoco',  0, 20, Encoding.BECH32M, False, False, False),
  ('joco',    1, 32, Encoding.BECH32,  False, False, False),
  ('tjoco',    2, 16, Encoding.BECH32,  False, False, False),
  ('rjoco', 16, 20, Encoding.BECH32,  False, False, False),
]
