...
LITECOIND=${BITCOIND:-$BINDIR/bluecoind}
LITECOINCLI=${BITCOINCLI:-$BINDIR/bluecoin-cli}
LITECOINTX=${BITCOINTX:-$BINDIR/bluecoin-tx}
LITECOINQT=${BITCOINQT:-$BINDIR/qt/bluecoin-qt}
