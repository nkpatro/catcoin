Contributing to Jocoin Core
============================

The Jocoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Jocoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/jocoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to jocoin-qt
...
The following applies to code changes to the Jocoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Jocoin
Network Protocol consensus changes.

Whether a pull request is merged into Jocoin Core rests with the project merge
...
Patches that change Jocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Jocoin consensus, it must have been
...
The project leader is the release manager for each Jocoin Core release.
