Contributing to Catcoin Core
============================

The Catcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Catcoin Core build
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to catcoin-qt
...
The following applies to code changes to the Catcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Catcoin
Network Protocol consensus changes.

Whether a pull request is merged into Catcoin Core rests with the project merge
...
Patches that change Catcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Catcoin consensus, it must have been
...
The project leader is the release manager for each Catcoin Core release.
