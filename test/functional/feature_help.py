...
"""Verify that starting counosx with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start counosx with -h for help text")
        ...
        self.log.info("Start counosx with -version for version information")
        ...
        self.log.info("Start counosxd with -fakearg to make sure it does not start")
