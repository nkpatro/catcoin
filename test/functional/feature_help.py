...
"""Verify that starting gheran with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gheran with -h for help text")
        ...
        self.log.info("Start gheran with -version for version information")
        ...
        self.log.info("Start gherand with -fakearg to make sure it does not start")
