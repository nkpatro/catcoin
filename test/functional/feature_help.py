...
"""Verify that starting scpfoundation with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start scpfoundation with -h for help text")
        ...
        self.log.info("Start scpfoundation with -version for version information")
