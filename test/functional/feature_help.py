...
"""Verify that starting bwrgo with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bwrgo with -h for help text")
        ...
        self.log.info("Start bwrgo with -version for version information")
        ...
        self.log.info("Start bwrgod with -fakearg to make sure it does not start")
