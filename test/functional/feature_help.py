...
"""Verify that starting catcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start catcoin with -h for help text")
        ...
        self.log.info("Start catcoin with -version for version information")
        ...
        self.log.info("Start catcoind with -fakearg to make sure it does not start")
