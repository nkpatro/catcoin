...
"""Verify that starting bluecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bluecoin with -h for help text")
        ...
        self.log.info("Start bluecoin with -version for version information")
        ...
        self.log.info("Start bluecoind with -fakearg to make sure it does not start")
