...
"""Verify that starting jocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start jocoin with -h for help text")
        ...
        self.log.info("Start jocoin with -version for version information")
        ...
        self.log.info("Start jocoind with -fakearg to make sure it does not start")
