...
"""Verify that starting datacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start datacoin with -h for help text")
        ...
        self.log.info("Start datacoin with -version for version information")
        ...
        self.log.info("Start datacoind with -fakearg to make sure it does not start")
