...
# The block reward of coinbaseoutput.nValue (50) LTC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 LTC/block.
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test -getinfo and litecoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (LTC/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (LTC/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 LTC) to the default wallet.
            ...
            # Test litecoin-cli -generate with -rpcwallet in multiwallet mode.
