...
class ZMQTest (BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [["-whitelist=noban@127.0.0.1", "-mempoolreplacement=1"]] * self.num_nodes
    ...
    def test_sequence(self):
        ...
        block = create_block(int(self.nodes[0].getbestblockhash(), 16), create_coinbase(self.nodes[0].getblockcount()+1), txlist=txs_to_add, version=0x20000000)
