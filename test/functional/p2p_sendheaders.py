...
class SendHeadersTest(BitcoinTestFramework):
    ...
    def test_null_locators(self, test_node, inv_node):
        ...
        block = create_block(int(tip["hash"], 16), create_coinbase(tip["height"] + 1), tip["mediantime"] + 1, version=0x20000000)
        block.solve()
    ...
    def test_nonnull_locators(self, test_node, inv_node):
        ...
        for i in range(4):
            ...
            if i == 0:
                ...
                new_block = create_block(tip, create_coinbase(height + 1), block_time, version=0x20000000)
                new_block.solve()
        ...
        for i in range(10):
            ...
            for j in range(2):
                ...
                blocks = []
                for _ in range(i + 1):
                    blocks.append(create_block(tip, create_coinbase(height), block_time, version=0x20000000))
                    blocks[-1].solve()
                    tip = blocks[-1].sha256
                    block_time += 1
                    height += 1
