...
class MiningTest(BitcoinTestFramework):
    ...
    def mine_chain(self):
        ...
        self.restart_node(0, extra_args=[f'-mocktime={t}', '-blockversion=536872249'])
        self.connect_nodes(0, 1)
        assert_equal(536872249, self.nodes[0].getblocktemplate(NORMAL_GBT_REQUEST_PARAMS)['version'])
