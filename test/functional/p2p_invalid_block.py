...
class InvalidBlockRequestTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        block2 = create_block(tip, create_coinbase(height), block_time, txlist=[tx1, tx2], version=0x20000000)
        block_time += 1
        block2.solve()
        ...
        block3 = create_block(tip, create_coinbase(height, nValue=100), block_time, version=0x20000000)
        block_time += 1
        block3.solve()
        ...
        tx3.rehash()
        block4 = create_block(tip, create_coinbase(height), block_time, txlist=[tx3], version=0x20000000)
        block4.solve()
        ...
        block = create_block(tip, create_coinbase(height), t + MAX_FUTURE_BLOCK_TIME + 1, version=0x20000000)
        block.solve()
