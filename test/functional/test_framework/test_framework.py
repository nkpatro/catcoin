...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    """Base class for a bwrgo test script.

    Individual bwrgo test scripts should subclass this class and override the set_test_params() and run_test() methods.
    ...
    def main(self):
        ...
        parser.add_argument("--usecli", dest="usecli", default=False, action="store_true",
                            help="use bwrgo-cli instead of RPC for all commands")
        ...
        self.options.bitcoind = os.getenv("LITECOIND", default=config["environment"]["BUILDDIR"] + '/src/bwrgod' + config["environment"]["EXEEXT"])
        self.options.bitcoincli = os.getenv("LITECOINCLI", default=config["environment"]["BUILDDIR"] + '/src/bwrgo-cli' + config["environment"]["EXEEXT"])
        ...
        if not self.options.noshutdown:
            ...
            self.log.info("Note: bwrgods were not stopped and may still be running")
    ...
    def stop_node(self, i, expected_stderr=''):
        """Stop a bwrgod test node"""
        self.nodes[i].stop_node(expected_stderr)
        self.nodes[i].wait_until_stopped()

    def stop_nodes(self):
        """Stop multiple bwrgod test nodes"""
        for node in self.nodes:
