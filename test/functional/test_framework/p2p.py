...
"""Test objects for interacting with a litecoind node over the p2p protocol.

The P2PInterface objects interact with the litecoind nodes under test using the
