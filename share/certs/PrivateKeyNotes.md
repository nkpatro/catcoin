...
unlocked to sign the Fieldcoin-Qt.app bundle.
...
allowing somebody to distribute a Fieldcoin-Qt.app or fieldcoin-qt-setup.exe with a valid
...
that the fieldcoin-qt.exe file inside the installer had not been tampered with.
