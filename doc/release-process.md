...
* Update manpages, see [gen-manpages.sh](https://github.com/neoncoin/litecoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/neoncoin/gitian.sigs.ltc.git
    git clone https://github.com/neoncoin/litecoin-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/neoncoin/litecoin.git

### Neoncoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Neoncoin Core for Linux, Windows, and OS X:
...
- Detached signatures will then be committed to the [litecoin-detached-sigs](https://github.com/neoncoin/litecoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Optionally twitter, reddit /r/Neoncoin, ... but this will usually sort out itself

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/neoncoin/litecoin/releases/new) with a link to the archived release notes.
