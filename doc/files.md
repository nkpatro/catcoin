...
* bluecoin.conf: contains configuration settings for bluecoind or bluecoin-qt
* bluecoind.pid: stores the process id of bluecoind while running
...
* debug.log: contains debug information and general logging generated by bluecoind or bluecoin-qt
