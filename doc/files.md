...
* infcoin.conf: contains configuration settings for infcoind or infcoin-qt
* infcoind.pid: stores the process id of infcoind while running
...
* debug.log: contains debug information and general logging generated by infcoind or infcoin-qt
