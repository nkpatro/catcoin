...
* bwrgo.conf: contains configuration settings for bwrgod or bwrgo-qt
* bwrgod.pid: stores the process id of bwrgod while running
...
* debug.log: contains debug information and general logging generated by bwrgod or bwrgo-qt
