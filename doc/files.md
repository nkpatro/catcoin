...
* counosx.conf: contains configuration settings for counosxd or counosx-qt
* counosxd.pid: stores the process id of counosxd while running
...
* debug.log: contains debug information and general logging generated by counosxd or counosx-qt
