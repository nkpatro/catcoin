...
* flamecoin.conf: contains configuration settings for flamecoind or flamecoin-qt
* flamecoind.pid: stores the process id of flamecoind while running
...
* debug.log: contains debug information and general logging generated by flamecoind or flamecoin-qt
