...
This guide describes how to build litecoind, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run litecoind or the GUI.
