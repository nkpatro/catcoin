...
2.  Build Catcoin Core:
    ...
    Configure and build the headless Catcoin Core binaries as well as the GUI (if Qt is found).
...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, Catcoin Core may be
