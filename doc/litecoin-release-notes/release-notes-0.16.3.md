Catcoin Core version 0.16.3 is now available from:

  <https://download.catcoin.org/catcoin-0.16.3/>
...
Catcoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
