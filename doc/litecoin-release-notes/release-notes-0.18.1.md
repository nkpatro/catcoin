Catcoin Core version 0.18.1 is now available from:
...
- Since version 0.16.0, Catcoin Core’s built-in wallet has defaulted to
...
- On macOS, Catcoin Core now opts out of application CPU throttling
