Jocoin Core version *0.15.1* is now available from:

  <https://download.jocoin.org/jocoin-0.15.1/>
...
A number of changes to the way Jocoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 tJOCO per kB (0.00001 JOCO). This is to prepare for dropping the minimum transaction fee to 0.1 tJOCO per kB (0.0001 JOCO) in the next release.
