...
It is possible to run Neoncoin as a Tor hidden service, and connect to such services.
...
The first step is running Neoncoin behind a Tor proxy. This will already make all
...
Neoncoin Core automatically creates a hidden service to listen on. This will positively 
affect the number of available .onion nodes.

This new feature is enabled by default if Neoncoin Core is listening (`-listen`), and
