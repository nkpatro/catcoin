...
*Setup instructions for a Gitian build of Neoncoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Neoncoin
...
- [Building Neoncoin Core](#building-litecoin-core)
...
git clone https://github.com/neoncoin/litecoin
...
Building Neoncoin Core
----------------

To build Neoncoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/neoncoin/litecoin
...
[neoncoin/gitian.sigs.ltc](https://github.com/neoncoin/gitian.sigs.ltc/) repository, or if that's not possible create a pull
