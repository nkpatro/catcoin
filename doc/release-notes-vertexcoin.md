Vertexcoin Core version *0.15.1* is now available from:
  ...
  <https://download.vertexcoin.org/vertexcoin-0.15.1/>
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 vertexs per kB (0.00001 VERX). This is to prepare for dropping the minimum transaction fee to 0.1 vertexs per kB (0.0001 VERX) in the next release.
