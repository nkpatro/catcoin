UNIX BUILD NOTES
====================
Some notes on how to build Positive Core in Unix.
...
memory available when compiling Positive Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Positive Core without wallet.
...
If you want to build Positive-Qt, make sure that the required packages for Qt development
...
As mentioned above, when maintaining portability of the wallet between the standard Positive Core distributions and independently built
