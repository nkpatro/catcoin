...
Assumeutxo is a feature that allows fast bootstrapping of a validating litecoind
...
considered active. This is the "traditional" mode of operation for litecoind.
...
**Failure consideration:** if litecoind unexpectedly halts after `m_stop_use` is set on
...
### Litecoind restarts sometime after snapshot validation has completed

When litecoind initializes again, what began as the snapshot chainstate is now
