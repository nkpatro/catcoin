...
The Positive Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Positive Core requires ZeroMQ API version 4.x or
...
using. Positived appends an up-counting sequence number to each
