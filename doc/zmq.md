...
The Neoncoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Neoncoin Core requires ZeroMQ API version 4.x or
...
using. Neoncoind appends an up-counting sequence number to each
