...
```sh
$ litecoin-cli createwallet "hww" true true "" true true true
```
...
```sh
$ litecoin-cli -rpcwallet=<wallet> getnewaddress
$ litecoin-cli -rpcwallet=<wallet> walletdisplayaddress <address>
```
...
```sh
$ litecoin-cli -rpcwallet=<wallet> sendtoaddress <address> <amount>
```
