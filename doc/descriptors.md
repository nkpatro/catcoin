# Support for Output Descriptors in bwrgocoin Core

Since bwrgocoin Core v0.17, there is support for Output Descriptors in the
...
on bwrgocoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing bwrgocoin Core wallets, a convenience function `combo` is
