# Support for Output Descriptors in CounosX Core

Since CounosX Core v0.17, there is support for Output Descriptors in the
...
on CounosX's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing CounosX Core wallets, a convenience function `combo` is
