# Support for Output Descriptors in Gheran Core

Since Gheran Core v0.17, there is support for Output Descriptors. This is a
...
on Gheran's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Gheran Core wallets, a convenience function `combo` is
