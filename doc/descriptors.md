# Support for Output Descriptors in Jocoin Core

Since Jocoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `joco1...` for mainnet or `tjoco1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Jocoin Core wallets, a convenience function `combo` is
