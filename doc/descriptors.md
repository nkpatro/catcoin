# Support for Output Descriptors in Catcoin Core

Since Catcoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Catcoin Core wallets, a convenience function `combo` is
