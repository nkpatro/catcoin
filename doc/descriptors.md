# Support for Output Descriptors in Bluecoin Core

Since Bluecoin Core v0.17, there is support for Output Descriptors in the
...
on Bluecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bluecoin Core wallets, a convenience function `combo` is
