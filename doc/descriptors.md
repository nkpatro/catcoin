# Support for Output Descriptors in Datachain Core

Since Datachain Core v0.17, there is support for Output Descriptors. This is a
...
on Datachain's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Datachain Core wallets, a convenience function `combo` is
