Neoncoin Core version *0.15.1* is now available from:
...
A number of changes to the way Neoncoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 lites per kB (0.00001 NEON). This is to prepare for dropping the minimum transaction fee to 0.1 lites per kB (0.0001 NEON) in the next release.
