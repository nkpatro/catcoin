...
It is possible to specify `litecoind` arguments to the `fuzz` executable.
...
Core without having to write any custom fuzzing harness. The `litecoind` server
