...
#ifndef H_FIELDCOIN_SCRIPT
#define H_FIELDCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CFieldcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Fieldcoin always counted CHECKMULTISIGs
