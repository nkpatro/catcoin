...
#ifndef _FIELDCOINRPC_H_
#define _FIELDCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Fieldcoin is not connected
...
/**
 * Fieldcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
