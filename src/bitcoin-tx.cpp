...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " gheran-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  gheran-tx [options] <hex-tx> [commands]  Update hex-encoded gheran transaction\n" +
            "or:     gheran-tx [options] -create [commands]   Create hex-encoded gheran transaction\n" +
            "\n";
