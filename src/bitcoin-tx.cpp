...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s jeanjohncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  jeanjohncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jeanjohncoin transaction") + "\n" +
              "  jeanjohncoin-tx [options] -create [commands]   " + _("Create hex-encoded jeanjohncoin transaction") + "\n" +
              "\n";
