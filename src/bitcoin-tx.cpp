...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " counosx-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  counosx-tx [options] <hex-tx> [commands]  Update hex-encoded counosx transaction\n" +
            "or:     counosx-tx [options] -create [commands]   Create hex-encoded counosx transaction\n" +
            "\n";
