...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tapcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tapcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tapcoin transaction") + "\n" +
              "  tapcoin-tx [options] -create [commands]   " + _("Create hex-encoded tapcoin transaction") + "\n" +
              "\n";
