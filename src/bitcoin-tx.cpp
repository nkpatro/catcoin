...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " catcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  catcoin-tx [options] <hex-tx> [commands]  Update hex-encoded catcoin transaction\n" +
            "or:     catcoin-tx [options] -create [commands]   Create hex-encoded catcoin transaction\n" +
            "\n";
