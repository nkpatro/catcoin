...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s infcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  infcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded infcoin transaction") + "\n" +
              "  infcoin-tx [options] -create [commands]   " + _("Create hex-encoded infcoin transaction") + "\n" +
              "\n";
