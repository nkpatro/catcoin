...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bwrgo-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bwrgo-tx [options] <hex-tx> [commands]  Update hex-encoded bwrgo transaction\n" +
            "or:     bwrgo-tx [options] -create [commands]   Create hex-encoded bwrgo transaction\n" +
            "\n";
