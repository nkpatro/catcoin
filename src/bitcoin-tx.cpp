...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s scpfoundation-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  scpfoundation-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded scpfoundation transaction") + "\n" +
              "  scpfoundation-tx [options] -create [commands]   " + _("Create hex-encoded scpfoundation transaction") + "\n" +
              "\n";
