...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s flamecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  flamecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded flamecoin transaction") + "\n" +
              "  flamecoin-tx [options] -create [commands]   " + _("Create hex-encoded flamecoin transaction") + "\n" +
              "\n";
