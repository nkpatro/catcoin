...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kipcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kipcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kipcoin transaction") + "\n" +
              "  kipcoin-tx [options] -create [commands]   " + _("Create hex-encoded kipcoin transaction") + "\n" +
              "\n";
