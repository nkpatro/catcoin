...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vertexcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vertexcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vertexcoin transaction") + "\n" +
              "  vertexcoin-tx [options] -create [commands]   " + _("Create hex-encoded vertexcoin transaction") + "\n" +
              "\n";
