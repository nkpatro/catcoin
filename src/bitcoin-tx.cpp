...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " jocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  jocoin-tx [options] <hex-tx> [commands]  Update hex-encoded jocoin transaction\n" +
            "or:     jocoin-tx [options] -create [commands]   Create hex-encoded jocoin transaction\n" +
            "\n";
