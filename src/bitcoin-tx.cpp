...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s khmerriel-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  khmerriel-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded khmerriel transaction") + "\n" +
              "  khmerriel-tx [options] -create [commands]   " + _("Create hex-encoded khmerriel transaction") + "\n" +
              "\n";
