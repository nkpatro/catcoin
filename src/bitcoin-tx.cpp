...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " datacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  datacoin-tx [options] <hex-tx> [commands]  Update hex-encoded datacoin transaction\n" +
            "or:     datacoin-tx [options] -create [commands]   Create hex-encoded datacoin transaction\n" +
            "\n";
