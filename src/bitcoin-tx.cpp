...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s veercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  veercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded veercoin transaction") + "\n" +
              "  veercoin-tx [options] -create [commands]   " + _("Create hex-encoded veercoin transaction") + "\n" +
              "\n";
