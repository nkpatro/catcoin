...
const std::string EXAMPLE_ADDRESS[2] = {"ltc1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl", "ltc1q02ad21edsxd23d32dfgqqsz4vv4nmtfzuklhy3"};
...
{
    std::string result = "> litecoin-cli -named " + methodname;
