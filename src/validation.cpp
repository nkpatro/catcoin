...
#if defined(NDEBUG)
# error "Veercoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Veercoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s VEER additional fees, %d delta bytes\n",
