...
#if defined(NDEBUG)
# error "KhmerRiel cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "KhmerRiel Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s KHR additional fees, %d delta bytes\n",
