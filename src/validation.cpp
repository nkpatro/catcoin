...
#if defined(NDEBUG)
# error "JeanJohnCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "JeanJohnCoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s JJC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("jeanjohncoin-scriptch");
