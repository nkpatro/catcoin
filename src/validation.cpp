...
#if defined(NDEBUG)
# error "Kipcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Kipcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s KIPC additional fees, %d delta bytes\n",
