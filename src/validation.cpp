...
#if defined(NDEBUG)
# error "SCPFoundation cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "SCPFoundation Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SCP-F additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("scpfoundation-scriptch");
