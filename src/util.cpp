...
const char * const BITCOIN_CONF_FILENAME = "infcoin.conf";
const char * const BITCOIN_PID_FILENAME = "infcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Infcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Infcoin";
#else
    // Unix
    return pathRet / ".infcoin";
#endif
#endif
}
