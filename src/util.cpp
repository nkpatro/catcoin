...
const char * const BITCOIN_CONF_FILENAME = "tapcoin.conf";
const char * const BITCOIN_PID_FILENAME = "tapcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Tapcoin";
#else
    // Unix
