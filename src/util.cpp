...
const char * const BITCOIN_CONF_FILENAME = "veercoin.conf";
const char * const BITCOIN_PID_FILENAME = "veercoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Veercoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Veercoin";
#else
    // Unix
    return pathRet / ".veercoin";
#endif
#endif
}
