...
const char * const BITCOIN_CONF_FILENAME = "bluecoin.conf";
const char * const BITCOIN_PID_FILENAME = "bluecoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bluecoin";
#else
    // Unix
