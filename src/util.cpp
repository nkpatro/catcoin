...
const char * const BITCOIN_CONF_FILENAME = "bwrgo.conf";
const char * const BITCOIN_PID_FILENAME = "bwrgo.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "bwrgocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/bwrgocoin";
#else
    // Unix
