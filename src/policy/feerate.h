...
enum class FeeEstimateMode {
    ...
    BTC_KVB,      //!< Use LTC/kvB fee rate unit
    SAT_VB,       //!< Use sat/vB fee rate unit
};

/**
 * Fee rate in litoshis per kilovirtualbyte: CAmount / kvB
 */
class CFeeRate
{
private:
    /** Fee rate in sat/kvB (litoshis per 1000 virtualbytes) */
    CAmount nSatoshisPerK;

public:
    /** Fee rate of 0 litoshis per kvB */
    ...
    /**
     * Construct a fee rate from a fee in litoshis and a vsize in vB.
     *
