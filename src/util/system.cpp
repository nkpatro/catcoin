...
const char * const BITCOIN_CONF_FILENAME = "gheran.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Gheran";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Gheran";
#else
    // Unix
    return pathRet / ".gheran";
#endif
#endif
}
