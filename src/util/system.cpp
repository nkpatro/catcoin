...
const char * const BITCOIN_CONF_FILENAME = "jocoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Jocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Jocoin";
#else
    // Unix-like
    return pathRet / ".jocoin";
#endif
#endif
}
