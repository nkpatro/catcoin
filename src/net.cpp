...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Diffcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"diffcointools.com", "dnsseed.diffcointools.com"},
    {"diffcoinpool.org", "dnsseed.diffcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"diffcointools.com", "testnet-seed.diffcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Diffcoin is probably already running."), addrBind.ToString().c_str());
        else
