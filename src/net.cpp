...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Calcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"calcointools.com", "dnsseed.calcointools.com"},
    {"calcoinpool.org", "dnsseed.calcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"calcointools.com", "testnet-seed.calcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Calcoin is probably already running."), addrBind.ToString().c_str());
        else
