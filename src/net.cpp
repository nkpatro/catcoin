...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Vespene " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"vespenetools.com", "dnsseed.vespenetools.com"},
    {"vespenepool.org", "dnsseed.vespenepool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"vespenetools.com", "testnet-seed.vespenetools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Vespene is probably already running."), addrBind.ToString().c_str());
        else
