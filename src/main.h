...
static const int64 DUST_SOFT_LIMIT = 10000; // 00010000 0.0001 TEMPLE
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0001000 0.00001 TEMPLE mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 271828182845904523; //2.718 281 828.4590 4523 536028747135266249775// * COIN;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
static const int COINBASE_MATURITY = 325;
