...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 CAL
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 CAL mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 206500000000 * COIN;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 720 / 250; // Calcoin: 720 blocks found a day. Priority cutoff is 100 calcoin day / 250 bytes.
    }
