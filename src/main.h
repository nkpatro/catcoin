...
#ifndef FIELDCOIN_MAIN_H
#define FIELDCOIN_MAIN_H
...
static const unsigned int MAX_TX_COMMENT_LEN = 140; // Fieldcoin: 128 bytes + little extra

static const int64 MIN_TX_FEE = 1000000;
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64 MAX_MONEY = 325000000 * COIN; // FieldCoin: maximum of 325M coins
...
public:
    ...
    */
    ...
    /** Amount of fieldcoins spent by this transaction.
    ...
    /** Amount of fieldcoins coming in to this transaction
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // FieldCoin: 1440 blocks found a day. Priority cutoff is 1 fieldcoin day / 250 bytes.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("0457575678901234567890000222222333444555666777888999000000aaaaabbbbbcccccdddddeeeeeff00ff00ff00ff001234567890abcdef0022446688abc89")))
