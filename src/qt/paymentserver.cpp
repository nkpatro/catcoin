...
const QString BITCOIN_IPC_PREFIX("counosx:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/counosx-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/counosx-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/counosx-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start counosx: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("counosx://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'counosx://' is not a valid URI. Use 'counosx:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid CounosX address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
