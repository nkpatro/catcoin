...
const char* BIP71_MIMETYPE_PAYMENT = "application/datacoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/datacoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/datacoin-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start datacoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("datacoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'datacoin://' is not a valid URI. Use 'datacoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Datachain address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
