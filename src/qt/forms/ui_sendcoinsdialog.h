...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 BLU"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 BLU"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 BLU"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 BLU"));
        ...
        labelBalance->setText(QStringLiteral("123.456 BLU"));
