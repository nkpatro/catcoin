...
<context>
    ...
    <message>
        <source>A message that was attached to the bluecoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Litecoin network.</source>
