...
uint256 hashGenesisBlock("0x9c1206ede85106ba22361c4293eb83d9d4112f9b1a7cabc7d297e1c8af088510");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
     ...
     if(nHeight ==1) {
       nSubsidy = 3400000000 * COIN ;
     }
   if(nHeight >=2 && nHeight<=5256000) 
    {
        nSubsidy = 0.1 * COIN;
    }
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // TreasureSL: 3.5 days
static const int64 nTargetSpacing = 60; // TreasureSL: 1 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x66aff08b6147d8be7b14ca95491bec669ac78423ad0dee58b25eff7395d7bac7");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "TreasureSL coin make by 2019 in ROCK";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1546328112;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2095458925;

        if (fTestNet)
        {
            block.nTime    = 1546328103;
            block.nNonce   = 398554849;
        }
	if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xec9951523f872b6ebbcda0f9e8c1253a9ddd251648ac8f5f95ee4d367dd901db"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0xbd, 0xcd, 0xd5 }; // TreasureSL: increase each by adding 2 to bitcoin's value.
