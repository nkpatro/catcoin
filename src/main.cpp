                        ...
                        bool* pfMissingInputs)
{
    ...
    if (fCheckInputs)
    {
        ...
        {
            if (fInvalid)
                return error("CTxMemPool::accept() : FetchInputs found invalid tx %s", BlockHashStr(hash).c_str());
            if (pfMissingInputs)
        ...
        {
            return error("CTxMemPool::accept() : ConnectInputs failed %s", BlockHashStr(hash).c_str());
        }
    }
