...
constexpr static struct {
    ...
    unsigned int nonce;
} BLOCKINFO[]{{11, 0x00006a53}, {27, 0x00024ce2}, {6, 0x00003288}, {5, 0x000106cf}, {10, 0x0000aa69}, {22, 0x000060e9},
              {14, 0x0000b5af}, {6, 0x0000a906}, {10, 0x000020f0}, {22, 0x00000506}, {14, 0x000065e0}, {0, 0x000002ce},
              {10, 0x00007a1c}, {15, 0x000010b9}, {6, 0x0001c488}, {21, 0x000127e5}, {10, 0x0000069f}, {12, 0x0000e0cd},
              {25, 0x0000d6e3}, {27, 0x00012e27}, {12, 0x00004eb9}, {7, 0x00008044}, {18, 0x00000fbd}, {23, 0x00004fdb},
              {14, 0x00002ce6}, {9, 0x00004b9c}, {17, 0x000017fd}, {6, 0x00000378}, {3, 0x0001a1e2}, {6, 0x000041da},
              {20, 0x00006420}, {24, 0x000057e2}, {17, 0x000065ee}, {8, 0x0000b118}, {14, 0x000157a9}, {2, 0x00003973},
              {24, 0x0000f8c6}, {27, 0x00000461}, {4, 0x00006d4b}, {1, 0x00010bf1}, {25, 0x000005ed}, {5, 0x000077b4},
              {18, 0x0000c50a}, {17, 0x00017852}, {28, 0x00004669}, {30, 0x00003882}, {3, 0x00002546}, {1, 0x00003fd2},
              {16, 0x00008036}, {2, 0x0000a017}, {12, 0x00006218}, {27, 0x00002ade}, {11, 0x0002d971}, {19, 0x0000d68e},
              {28, 0x00006759}, {2, 0x00005613}, {18, 0x000168fa}, {18, 0x000049cd}, {3, 0x0000bcc7}, {16, 0x00011bde},
              {7, 0x00019019}, {24, 0x00003f2f}, {16, 0x00001f41}, {28, 0x00006e31}, {8, 0x000093e2}, {17, 0x00003abc},
              {26, 0x0000bb8f}, {28, 0x000016b8}, {10, 0x00029fd8}, {10, 0x0000679d}, {20, 0x000021f5}, {4, 0x00009b52},
              {20, 0x0000754f}, {0, 0x00001ad4}, {25, 0x0000aaad}, {7, 0x000037e4}, {16, 0x000056a2}, {23, 0x00016e6d},
              {12, 0x00001f97}, {22, 0x0000ebb5}, {9, 0x00005dbe}, {4, 0x00004f93}, {8, 0x00002b62}, {8, 0x00000df7},
              {15, 0x00008fe3}, {10, 0x0000932f}, {10, 0x00001bfd}, {13, 0x0000212f}, {19, 0x00007a57}, {15, 0x00009847},
              {28, 0x000109aa}, {16, 0x0000101f}, {19, 0x0001d7af}, {25, 0x00003428}, {19, 0x00013412}, {0, 0x000074f3},
              {27, 0x0000f283}, {18, 0x00002cb7}, {28, 0x00005b3e}, {18, 0x0000087e}, {30, 0x000031ae}, {3, 0x00008dad},
              {0, 0x00013524}, {24, 0x000010ba}, {31, 0x00005ebc}, {15, 0x000165a4}, {16, 0x0001c3c4}, {28, 0x000001c6},
              {28, 0x00002a37}, {5, 0x00002b70}};
...
void MinerTestingSetup::TestBasicMining(const CChainParams& chainparams, const CScript& scriptPubKey, const std::vector<CTransactionRef>& txFirst, int baseheight)
{
    ...
    while (m_node.chainman->ActiveChain().Tip()->nHeight < 839999) {
    ...
    BOOST_CHECK(pblocktemplate = AssemblerForTest(chainparams).CreateNewBlock(scriptPubKey));
    // Extend to an 840000-long block chain.
    while (m_node.chainman->ActiveChain().Tip()->nHeight < 840000) {
        CBlockIndex* prev = m_node.chainman->ActiveChain().Tip();
        CBlockIndex* next = new CBlockIndex();
        next->phashBlock = new uint256(InsecureRand256());
        m_node.chainman->ActiveChainstate().CoinsTip().SetBestBlock(next->GetBlockHash());
