...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/veercoin-project/veercoin>";
    const std::string URL_WEBSITE = "<https://veercoin.org>";
