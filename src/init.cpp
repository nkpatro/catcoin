...
void Shutdown()
{
    ...
    RenameThread("jeanjohncoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/jeanjohncoin-project/jeanjohncoin>";
    const std::string URL_WEBSITE = "<https://jeanjohncoin.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("jeanjohncoin-loadblk");
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if jeanjohncoin is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if jeanjohncoin is started while in a temporary directory.\n",
