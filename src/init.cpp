...
void Shutdown()
{
    ...
    RenameThread("scpfoundation-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/scpfoundation-project/scpfoundation>";
    const std::string URL_WEBSITE = "<https://scpfoundation.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("scpfoundation-loadblk");
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if scpfoundation is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if scpfoundation is started while in a temporary directory.\n",
