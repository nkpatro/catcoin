...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/khmerriel-project/khmerriel>";
    const std::string URL_WEBSITE = "<https://khmerriel.org>";
