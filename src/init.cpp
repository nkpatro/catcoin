...
void Shutdown()
{
    ...
    RenameThread("flamecoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/flamecoin-project/flamecoin>";
    const std::string URL_WEBSITE = "<https://flamecoin.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("flamecoin-loadblk");
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if flamecoin is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if flamecoin is started while in a temporary directory.\n",
