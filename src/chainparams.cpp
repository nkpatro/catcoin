...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.jocoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.jocointools.com");
        vSeeds.emplace_back("dnsseed.jocoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.jocointools.com");
        vSeeds.emplace_back("seed-b.jocoin.loshan.co.uk");
