...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.kipcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.kipcointools.com", true);
        vSeeds.emplace_back("dnsseed.kipcoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.kipcointools.com", true);
        vSeeds.emplace_back("seed-b.kipcoin.loshan.co.uk", true);
