...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.veercoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.veercointools.com", true);
        vSeeds.emplace_back("dnsseed.veercoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.veercointools.com", true);
        vSeeds.emplace_back("seed-b.veercoin.loshan.co.uk", true);
