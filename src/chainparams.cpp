...
{
    const char* pszTimestamp = "BBC NEWS 28/Jun/2021 North Korea: Citizens ‘worried’ by Kim Jong-un weight loss";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1624913873, 402173, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa4943578c1871e34b5c4f15eb114d104916397cf8e9d1d166b0cd1df721ee1ba"));
        assert(genesis.hashMerkleRoot == uint256S("0x83a52c417bf444141da2ec88772e74173fa6149245c613fe49ce0ba74ccdb1d5"));
        ...
        /*vSeeds.emplace_back("seed-a.gheran.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.gherantools.com");
        vSeeds.emplace_back("dnsseed.gheranpool.org");*/
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x47, 0x52, 0x5E, 0x12};
        base58Prefixes[EXT_SECRET_KEY] = {0x47, 0x52, 0x36, 0x86};
        ...
        checkpointData = {
            {
                /*{     0, uint256S("0xa4943578c1871e34b5c4f15eb114d104916397cf8e9d1d166b0cd1df721ee1ba")},
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.gherantools.com");
        vSeeds.emplace_back("seed-b.gheran.loshan.co.uk");
