...
{
    const char* pszTimestamp = "MSN 22/June/2019 Mike Skotts 40th bday";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1561141056, 2085284394, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("e1b465ff62aa626e42b7562e004a738ec0559b617a59c3eeffbcceaab271f532"));
        assert(genesis.hashMerkleRoot == uint256S("4440f693ab08abb250972b5116bc136c79e8ffd10b6a88329771f50d29d5b9e8"));
        ...
        //vSeeds.emplace_back("seed-a.bwrgo.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
       // vSeeds.emplace_back("dnsseed.bwrgotools.com");
        //vSeeds.emplace_back("dnsseed.bwrgopool.org");
...
public:
    CTestNetParams() {
        ...
        //vSeeds.emplace_back("testnet-seed.bwrgotools.com");
        //vSeeds.emplace_back("seed-b.bwrgo.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1561141056, 0, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("e1b465ff62aa626e42b7562e004a738ec0559b617a59c3eeffbcceaab271f532"));
        assert(genesis.hashMerkleRoot == uint256S("4440f693ab08abb250972b5116bc136c79e8ffd10b6a88329771f50d29d5b9e8"));
