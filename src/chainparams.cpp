...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("jjcseed.bertho.fr");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.jeanjohncointools.com");
        //vSeeds.emplace_back("dnsseed.jeanjohncoinpool.org");
...
public:
    CTestNetParams() {
        ...
        //vSeeds.emplace_back("testnet-seed.jeanjohncointools.com");
        //vSeeds.emplace_back("seed-b.jeanjohncoin.loshan.co.uk");
